...
#define MyAppExe "Start_X-Amplicon_WebUI.cmd"
...
LicenseFile=..\LICENSE
InfoBeforeFile=..\X-Amplicon_main\README_RELEASE_zh.md
...
[Files]
Source: "..\X-Amplicon_main.zip"; DestDir: "{tmp}"; Flags: deleteafterinstall
...
[Icons]
Name: "{autoprograms}\X-Amplicon Web UI"; Filename: "{app}\{#MyAppExe}"; WorkingDir: "{app}"
Name: "{autodesktop}\X-Amplicon Web UI"; Filename: "{app}\{#MyAppExe}"; WorkingDir: "{app}"; Tasks: desktopicon
...
Filename: "{app}\{#MyAppExe}"; Description: "Launch X-Amplicon Web UI"; WorkingDir: "{app}"; Flags: postinstall skipifsilent nowait
